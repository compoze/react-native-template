    ...
    public render(): JSX.Element {
        ...
        return (
            <View style={styles.container}>
                <ImageBackground style={styles.imageBackground} source={require('../images/BackgroundOverlay.png')}>
                    <View style={{
                            flex: 3, maxWidth: '100%', marginBottom: 30,
                    ...
                    <Button onPress={this.googleLogin} invalid={false} buttonStyle={styles.continueWithGoogleButton}>
                        <View style={styles.continueWithGoogleContent}>
                            <Icon name='google' type='font-awesome' color='#4285F4' />
                            <Text style={{ fontWeight: styleConstants.fontWeight.BOLD, fontSize: styleConstants.fontSize.LARGE }}>Continue with Google</Text>
                        </View>
                    </Button>
                    <Text>Don't have an account? <Text style={styles.signUp} onPress={this.navigateToSignUp}>Sign Up</Text></Text>
